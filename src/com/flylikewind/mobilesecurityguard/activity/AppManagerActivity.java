...
import com.flylikewind.mobilesecurityguard.adapter.AppManagerAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv_app_manager.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO
				int i = arrayOfInt[0] + ScreenUtils.screenWidth / 5;
				int j = arrayOfInt[1];
				...
				// 400x640dpi
				/*
				 * ScreenUtils.screenWidth * 3 / 4, ScreenUtils.screenHeight / 7
				 * ScreenUtils.widthDpi * 3 / 4, ScreenUtils.heightDpi / 7
				 * 320:240x480:70
				 */
				localPopupWindow = new PopupWindow(popupview,
		...
		case R.id.ll_start:
			...
			try {
				...
				if (activityinfos.length > 0) {
					...
					Toast.makeText(this, "当前应用程序无法启动", Toast.LENGTH_SHORT)
							.show();
				}
			} catch (Exception e) {
